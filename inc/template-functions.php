 ...
 * @return array
 */
function cyclingclubbody_classes( $classes ) {
...
add_filter( 'body_class', 'cyclingclubbody_classes' );

/**
 * Add a pingback url auto-discovery header for singularly identifiable articles.
 */
function cyclingclubpingback_header() {
	if ( is_singular() && pings_open() ) {
		echo '<link rel="pingback" href="', esc_url( get_bloginfo( 'pingback_url' ) ), '">';
	}
}
add_action( 'wp_head', 'cyclingclubpingback_header' );
